    ...
    <div className="relative w-full overflow-hidden">
      <AnimatePresence initial={false} custom={direction} mode="wait">
        <motion.div key={currentSlide} custom={direction} variants={slideVariants} initial="enter" animate="center" exit="exit" transition={{
          ...
          <motion.img src={bannerSlides[currentSlide].image} alt="Ruchi Upadhyay Chemistry Classes" className="w-full h-[250px] md:h-auto object-cover md:object-contain" initial={{ scale: 1 }} animate={{ scale: 1.05 }} transition={{ duration: 5, ease: "linear" }} />
        </motion.div>
      </AnimatePresence>
