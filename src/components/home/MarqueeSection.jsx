...
const MarqueeSection = () => {
    return (<div className="bg-primary py-3 overflow-hidden">
      <div className="marquee-container">
        <div className="marquee-content">
          {/* Duplicate the content for seamless loop */}
          {[...announcements, ...announcements].map((item, index) => (<div key={index} className="inline-flex items-center gap-2 mx-8 text-primary-foreground font-medium">
