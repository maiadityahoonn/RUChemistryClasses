...
const ProfileDropdown = () => {
    ...
    return (<DropdownMenu>
            ...
            <DropdownMenuContent className="w-72 p-2 mt-2 bg-background/80 backdrop-blur-xl border-primary/10 shadow-2xl rounded-2xl overflow-hidden" align="end" forceMount>
                ...
                <div className="p-1">
                    <DropdownMenuItem onClick={handleSignOut} className="py-3 px-3 cursor-pointer rounded-xl text-red-500 focus:text-red-600 focus:bg-red-500/10 transition-all duration-200 group">
