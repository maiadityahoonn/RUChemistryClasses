...
const Login = () => {
  ...
  return (<div className="min-h-screen grid lg:grid-cols-2">
    ...
    <div className="flex items-center justify-center p-8">
      <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} className="w-full max-w-md space-y-8">
        {/* Logo */}
        <Link to="/" className="flex items-center">
          <img src={ruchiLogo} alt="Ruchi Upadhyay Chemistry Classes" className="h-14 w-auto" />
        </Link>
